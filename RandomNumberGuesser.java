...
public class RandomNumberGuesser 
{
	...
	public static void main(String[] args) 
	{
		...
		//uncounter used to decrease the count for each time the user enters
		//a number outside the bounds
		int uncounter = 0;
		...
		do
		{
			...
			do
			{
				...
				else 
				{
					...
					if(userGuess > randNum)
					{
						...
						System.out.println("Number of guesses is " + (random.getCount()- uncounter));
			...
			switch(userYesorNoStringInput)
			{
				...
				case "Yes":
				{
					...
					random.resetCount();
					//resets uncounter to 0
					uncounter = 0;
					random.inputValidation(1, 0, 100);
					//resets both low and high guess to default values
					lowGuess = 0;
					highGuess = 100;
					break;
				}
